...
<?php 
		...
		?>
			...
			E-mail: <a href="mailto:<?php echo get_post_meta(get_the_ID(), 'contact6', true) ?>" style="color:#f48b0b;"><?php echo get_post_meta(get_the_ID(), 'contact6', true) ?></a></p>
<?php endwhile; ?>
		</div>
		<div class="contact-form">
			<h3>Contact Form</h3>
			<form method="POST" action="http://express.businessonmarketst.com/wp/badri/wp-content/themes/sohotheme/mailformprocess.php">
